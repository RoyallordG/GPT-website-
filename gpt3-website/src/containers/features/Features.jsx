...
const Features = () => {
  return (
  <div className="features section-margin-bottom">
    <div className="first-column">
      <h1 className='gradient__text all-h1'>The Future is Now and You Just Need To Realize It. Step into Future Today & Make it Happen.</h1>
      <p className='p-tomato'>Request Early Access to Get Started</p>
    </div>
